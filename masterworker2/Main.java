...
class Main {
  ...
  public static void main(String[] args) {
    ...
    String platf  = args.length > 1 ? args[0] : "./deprecated/java/app/masterworker2/small_platform.xml";
    String deploy =  args.length > 1 ? args[1] : "./deprecated/java/app/masterworker2/masterworker.xml";
